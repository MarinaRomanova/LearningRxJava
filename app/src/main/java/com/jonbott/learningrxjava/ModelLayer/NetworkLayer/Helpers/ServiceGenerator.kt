package com.jonbott.datalayerexample.DataLayer.NetworkLayer.Helpers
...
object ServiceGenerator {
    val API_BASE_URL = "http://jsonplaceholder.typicode.com" //http://localhost:3000";
    ...
    private val builder = Retrofit.Builder()
                                  ...
                                  .addCallAdapterFactory(RxJava2CallAdapterFactory.create()) // required for RxRetrofit
